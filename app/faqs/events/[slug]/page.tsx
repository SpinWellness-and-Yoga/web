...
export default async function EventFAQPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
  
  const event = await getEventByIdWithCount(slug);
        ...
        <section className={styles.servicesSection}>
          <div className={styles.faqGrid}>
            ...
            <div className={styles.faqCard}>
              ...
              <p className={styles.faqAnswer}>
                {capitalizeWords('wear comfortable, breathable clothing that allows you to move freely (leggings, joggers, or athletic wear).')}
              </p>
            </div>
            <div className={styles.faqCard}>
