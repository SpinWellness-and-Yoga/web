...
export default function EventRegistrationClient({ 
  ...
  const spotsRemaining = capacity > 0 ? capacity - registrationCount : null;
  ...
  if (submitSuccess) {
    return (
      <div style={{ 
        ...
        <h3 style={{ color: '#151B47', marginBottom: '1rem', fontSize: '1.5rem', fontWeight: '600' }}>
  ...
  return (
    <>
      <div style={{ 
        ...
        <h2 style={{ fontSize: '1.8rem', marginBottom: '1.5rem', color: '#151B47' }}>
          {capitalizeWords('register')}
        </h2>
        {soldOut ? (
          <>
      ...
      {showForm && !soldOut && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '1.8rem', marginBottom: '1.5rem', color: '#151B47', paddingRight: '2rem' }}>
              register
            </h2>
